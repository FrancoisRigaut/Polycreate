package fr.polytech.mlg.releaze.house.design.services;
...
public class ProgramDebugServices extends AbstractGemocDebuggerServices {
	...
	protected List<StringCouple> getRepresentationRefreshList() {
		...
		res.add(new StringCouple("Program", "Debug"));

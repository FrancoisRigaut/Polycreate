...
/**
 * This is the item provider adapter for a {@link fr.polytech.mlg.releaze.house.polycreate.GoTo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GoToItemProvider extends InstructionItemProvider {
	...
	protected void addStateNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GoTo_stateName_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_GoTo_stateName_feature", "_UI_GoTo_type"),
						PolycreatePackage.Literals.GO_TO__STATE_NAME, true, false, false,
	...
	public String getText(Object object) {
		String label = ((GoTo) object).getStateName();
		return label == null || label.length() == 0 ? getString("_UI_GoTo_type")
